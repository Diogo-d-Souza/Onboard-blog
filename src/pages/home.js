        ...
        <main>
            ...
            <div className="main">
                <div className="tela_conteudo">
                    <button className="button_artigo" onClick={() => router.push("./publicar")}>
                        ...
                        <p className="p_botao">Publicar artigo</p>
                    </button>

                    <section className="artigo_principal">

                        <img className="img_principal" src="./imagem1.jpg" alt="Imagem 1"/> 
                        
                        <div className="conteudo">

                            <div className="titulos_principal">
                                <h2 className="h2_principal">Título: Lorem Ipsum</h2>

                                <h3 className="h3_principal">Tema: Lorem Ipsum</h3>
                            </div>
                    ...
                    <div className="linha_artigos1">
                        <Artigos_Logado imagem="./imagem2.jpg"></Artigos_Logado>
                        <Artigos_Logado imagem="./imagem3.jpg"></Artigos_Logado>
                        <Artigos_Logado imagem="./imagem4.jpg"></Artigos_Logado>
                    </div>
                    <div className="linha_artigos2">
                        <Artigos_Logado imagem="./imagem5.jpg"></Artigos_Logado>
                        <Artigos_Logado imagem="./imagem6.jpg"></Artigos_Logado>
                        <Artigos_Logado imagem="./imagem7.jpg"></Artigos_Logado>
                    </div>
                ...
                <div className="filtros">
                    <div className="icone_filtro">

                        <h2 className="h2_filtro">Filtros</h2>
                    ...
                    <Filtros_Logado nome="Autor"/>
                    <Filtros_Logado nome="Ano de publicação"/>
                    <Filtros_Logado nome="Título"/>
                    <Filtros_Logado nome="Avaliação"/>
